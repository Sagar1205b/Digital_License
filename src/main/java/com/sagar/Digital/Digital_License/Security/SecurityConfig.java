package com.sagar.Digital.Digital_License.Security;
...
//         Skip authorities (roles) for now, if not needed
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(configurer ->
                        configurer
                                .requestMatchers("/digital/signup","/digital/save","/digital/home","/digital/verify-otp","/css/**", "/js/**", "/assets/**","/img/**","/logos/**","/team/**").permitAll()
